...
const Contact = () => {
    return (
        <div className="bg-gray-200 pb-8">
            ...
            <div className="w-[90%] max-w-[1500px] mx-auto mt-8 flex flex-col items-center justify-center gap-5">
                <iframe
                ...
                ></iframe>
                <div className="flex justify-between items-center bg-white p-4 rounded w-full gap-5">
                    <form action="" className="flex flex-col gap-3 w-[50%]">
                        <h1 className="font-bold text-2xl mb-4">Contact</h1>
                        <input
                            type="text"
                            className="bg-gray-100 border-0 outline-none px-2 py-1.5 font-semibold tracking-widest rounded"
                            placeholder="Name"
                            required={true}
                        />
                        <input
                        ...
                        <textarea
                            name=""
                            id=""
                            className="bg-gray-100 border-0 outline-none px-2 py-1.5 font-semibold tracking-widest rounded resize-none h-[150px]"
                            placeholder="Comment"
                            required={true}
                        ></textarea>
                        <button
                            className="self-start text-sm uppercase text-white px-8 py-[6px] mt-4 rounded-full bg-footer-color"
                            type="submit"
                        >
                            Send
                        </button>
                    </form>
                    <div className="self-start w-[50%] flex flex-col justify-start items-start gap-3">
