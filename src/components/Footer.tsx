...
const Footer = () => {
    return (
        <>
            <footer className="footer-top border-b border-gray py-3 bg-footer-color">
                <div className="w-[90%] max-w-[1500px] mx-auto flex justify-between items-center gap-3 flex-wrap">
                    ...
                    <div className="flex justify-end items-center">
                        <div className="flex justify-center items-center w-full text-white border">
                            <input
                                type="text"
                                className="py-[6px]  px-5 rounded-sm w-[500px] outline-none text-black font-semibold tracking-widest text-sm"
            ...
            <footer className="footer-mid border-b border-gray py-3 flex justify-between items-center text-white bg-footer-color">
                <div className="w-[90%] max-w-[1500px] mx-auto flex justify-evenly gap-5 items-start">
                    <div className="flex flex-col gap-6 justify-center items-start">
                        <h1 className="font-bold text-xl">Contact Us</h1>
                        <ul className="flex flex-col font-semibold text-sm gap-3">
            ...
            <footer className="footer-bottom border-b border-gray py-3 flex justify-center items-center text-white bg-footer-color">
